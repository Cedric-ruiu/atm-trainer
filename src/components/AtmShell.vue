...
<template>
  <div class="min-h-dvh bg-[#2a2e33] flex items-center justify-center p-3">
    ...
    <!-- Info button — top-left corner of the device screen -->
    <button
      class="fixed top-3 left-3 z-9400 w-6 h-6 rounded-full border border-gray-400 text-gray-300 text-[11px] font-bold flex items-center justify-center opacity-40 hover:opacity-70 transition-opacity cursor-pointer"
