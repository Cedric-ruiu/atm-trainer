      ...
      >
        ...
        <div class="p-6">
          ...
          <button
            ...
            :style="confirmReset
              ? 'background: rgba(239,68,68,0.25); border-color: rgba(239,68,68,0.6); color: #fca5a5;'
              : 'background: rgba(239,68,68,0.12); border-color: rgba(239,68,68,0.3); color: rgba(239,68,68,0.7);'"
            @click="resetStats"
          >
            {{ confirmReset ? 'Confirmer la réinitialisation ?' : 'Réinitialiser toutes les statistiques ↺' }}
          </button>
